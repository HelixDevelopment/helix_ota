...
| OTA-020 | §16 | Fixed (→ Fixed.md) | Bug | Database migration test — 47 tests validating workable_items DB schema + Issues/Fixed sync (qa-results/workable_items/20260620T201912Z/) |
| OTA-019 | §9 | Completed (→ Fixed.md) | Task | Build resource stats tracker (§11.4.24, commit `300351c6`, evidence `docs/Stats.tsv`) |
